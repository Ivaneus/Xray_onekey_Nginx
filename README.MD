...
```
wget -N --no-check-certificate -q -O trojan.sh "https://raw.githubusercontent.com/Ivaneus/Xray_onekey_Nginx/nginx_forward/trojan.sh" && chmod +x trojan.sh && bash trojan.sh
```
